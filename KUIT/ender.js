/*!
  ...
  * Build: ender build bonzo@1.0.1 qwery@3.3.3 bean@0.4.9 klass@1.2.2
  * =============================================================
  */
...
!function () {
  ...
  !function (name, definition) {
    ...
    function isNode(el, t) {
      return el && typeof el !== 'string' && (t = el[nodeType]) && (t == 1 || t == 9)
    }
    ...
    , selectNonNative = function (selector, root) {
        ...
        if (m = selector.match(tagAndOrClass)) {
          r = classRegex(m[2])
          items = (gWebNow && root == doc && !m[1]) ? root.all : root[byTag](m[1] || '*')
  ...
  !function (name, context, definition) {
    ...
    var win = window
      ...
      , fireListener = W3C_MODEL ? function (isNative, type, element) {
          ...
          {
            console.error("Dispatch Event is not supported. " + e.message);
          }
